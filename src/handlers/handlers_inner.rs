...
pub async fn create_question(
    ...
    match question {
        ...
        Err(err) => {
            error!("{}", err);
            Err(HandlerError::default_internal_error()).into_report()
        }
    }
}
    ...
    match answer {
        ...
        Err(err) => {
            ...
            match err.current_context() {
                DBError::InvalidUUID(s) => Err(HandlerError::BadRequest(s.clone())),
...
mod tests {
    ...
    async fn create_question_should_return_error() {
        ...
        questions_dao.mock_create_question(Err(DBError::InvalidUUID("test".to_owned())).into_report());
        ...
        assert!(
            std::mem::discriminant(result.unwrap_err().current_context())
    ...
    async fn read_questions_should_return_error() {
        ...
        questions_dao.mock_get_questions(Err(DBError::InvalidUUID("test".to_owned())).into_report());
    ...
    async fn delete_question_should_return_error() {
        ...
        questions_dao.mock_delete_question(Err(DBError::InvalidUUID("test".to_owned())).into_report());
    ...
    async fn create_answer_should_return_bad_request_error() {
        ...
        answers_dao.mock_create_answer(Err(DBError::InvalidUUID("test".to_owned())).into_report());
    ...
    async fn create_answer_should_return_internal_error() {
        ...
        answers_dao.mock_create_answer(
    ...
    async fn read_answers_should_return_error() {
        ...
        answers_dao.mock_get_answers(Err(DBError::InvalidUUID("test".to_owned())).into_report());
    ...
    async fn delete_answer_should_return_error() {
        ...
        answers_dao.mock_delete_answer(Err(DBError::InvalidUUID("test".to_owned())).into_report());
